window.onload = (function() {
    ...
    Crafty.c("Box", {
         ...
         */
        makeBox: function(x, y, color, onMouseDown, onMouseUp) {
        ...
        _setupBoard: function(x, y, rows, cols, bw, bh) {
            this._board = _.range(cols).map(function(c) {
                return _.range(rows).map(function(r) {
                    ...
                    return Crafty.e("Box").makeBox(pos.x, pos.y, color, _.bind(this._mouseDown, this), _.bind(this._mouseUp, this));
                }, this);
            }, this);
        },
        /**
        ...
        _mouseDown: function(obj) {
            ...
            window._miniLoop = setInterval(function() {            
                if (!$this._blockUntil || $this._blockUntil < frame) {
                    ...
                    console.log(aPos);
                    console.log($this._board[aPos.x][aPos.y]);
                }
            }, 50);
